...
const setInderedients = (state, action) => {
...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.REMOVING_INGREDIENTS: return removeIngredient(state, action);
        case actionTypes.SET_INGREDIENTS: return setInderedients(state, action);
